...
function florist_flower_shop_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('florist_flower_shop_loader_icon',array(
        'default' => 'Two Way',
        'sanitize_callback' => 'florist_flower_shop_sanitize_choices'
	));
	$wp_customize->add_control('florist_flower_shop_loader_icon',array(
        'type' => 'select',
        'label' => esc_html__('Pre-Loader Type','florist-flower-shop'),
        'section' => 'florist_flower_shop_left_right',
        'choices' => array(
            'Two Way' => esc_html__('Two Way','florist-flower-shop'),
            'Dots' => esc_html__('Dots','florist-flower-shop'),
            'Rotate' => esc_html__('Rotate','florist-flower-shop')
        ),
	) );
	...
	$wp_customize->add_setting( 'florist_flower_shop_metabox_hide_show',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'florist_flower_shop_switch_sanitization'
    ));  
    $wp_customize->add_control( new Florist_Flower_Shop_Toggle_Switch_Custom_Control( $wp_customize, 'florist_flower_shop_metabox_hide_show',array(
      	'label' => esc_html__( 'Show / Hide Metabox','florist-flower-shop' ),
      	'section' => 'florist_flower_shop_responsive_media'
    )));
